...
app.use(express.urlencoded({ extended: true, limit: '10kb' })); //-this is to parse the data from the body of a form which uses form submit through an action. Here we need this middleware to basically parse the data, that is comming from the "urlencoded" from. this is an express builtin middleware.
